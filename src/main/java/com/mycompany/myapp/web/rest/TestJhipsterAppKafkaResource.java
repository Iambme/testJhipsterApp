...
@RestController
@RequestMapping("/api/test-jhipster-app-kafka")
public class TestJhipsterAppKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TestJhipsterAppKafkaResource.class);
    ...
    public TestJhipsterAppKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
